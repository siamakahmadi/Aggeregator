          ...
          <main className={theme === 'light' ? styles.contentDetail : styles.contentDetailDark}>
              ...
              <div className={styles.leftSide}>
                ...
                <div className={styles.toolBar}>
                  <div className={styles.exploreBtn}>
                    <Btn type="primary" hasIcon={true} link={content.post_info.website} title="Explore Site">
                      <RightFlash />
                    </Btn>
                  </div>
            ...
            <div className={styles.suggestPosts}>
              ...
              <div className={styles.postlist}>
                <CardLayout>
                  {related_posts > 0 ? <div> Related Posts Not Found</div> <Card title="hi" src="https://cdn.dribbble.com/userupload/4269145/file/original-c533e5366daed052e3c3236c085acbc7.png?resize=1024x768" />}
                </CardLayout>
              </div>
            </div>
          </main>
