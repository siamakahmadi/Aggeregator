...
export default function Page({ params }) {
  ...
  return (
    <>
      {content.data < 1 ? <div>Loading</div> : <main className={theme === 'light' ? styles.contentDetail : styles.contentDetailDark}>
          ...
          <div className={styles.leftSide}>
            ...
            <div className={styles.toolBar}>
              <div className={styles.exploreBtn}>
                <Btn type="primary" hasIcon={true} link={content.link} title="Explore Site">
                  <RightFlash />
                </Btn>
              </div>
