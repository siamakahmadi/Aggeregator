...
import RightFlash from '../Assets/svg/'
    ...
    <main className={ theme === 'light' ?  styles.contentDetail : styles.contentDetailDark}>
            ...
            <div className={styles.item}>
              <div className={styles.icon}>
                <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M7.4652 13.25L9.55327 0.522727H10.7962L8.7081 13.25H7.4652ZM1.6733 9.72017L1.87216 8.47727H11.3679L11.169 9.72017H1.6733ZM2.99077 13.25L5.07884 0.522727H6.32173L4.23366 13.25H2.99077ZM2.41903 5.29545L2.6179 4.05256H12.1136L11.9148 5.29545H2.41903Z" fill="#1A1A1A" />
                </svg>
              </div>
      ...
      <div className={styles.versionDetails}>
        <div className={styles.version}>
          <div className={styles.icon}>
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M5.24991 3.75468H11.6693M11.6693 6.99995H6.41707M7.58422 10.2452H11.6693M2.62382 3.46289C2.46267 3.46289 2.33203 3.59353 2.33203 3.75468C2.33203 3.91583 2.46267 4.04647 2.62382 4.04647C2.78497 4.04647 2.91561 3.91583 2.91561 3.75468C2.91561 3.59353 2.78497 3.46289 2.62382 3.46289ZM3.79097 6.70816C3.62982 6.70816 3.49918 6.8388 3.49918 6.99995C3.49918 7.1611 3.62982 7.29174 3.79097 7.29174C3.95212 7.29174 4.08276 7.1611 4.08276 6.99995C4.08276 6.8388 3.95212 6.70816 3.79097 6.70816ZM4.95812 9.95343C4.79697 9.95343 4.66634 10.0841 4.66634 10.2452C4.66634 10.4064 4.79697 10.537 4.95812 10.537C5.11928 10.537 5.24991 10.4064 5.24991 10.2452C5.24991 10.0841 5.11928 9.95343 4.95812 9.95343Z" stroke="#1A1A1A" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
          </div>
          <div className={styles.title}>
            Version 1.0
