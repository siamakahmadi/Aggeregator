            ...
            <div className={Styles.cardImage}>
                ...
                <div className={theme === 'dark' ? Styles.imageToolbarDark : Styles.imageToolbarLight}>
                    <div className={Styles.add}>
                        {!isBookmark ? <div onClick={()=>{!isBookmark ? setIsBookmark(false) : setIsBookmark(true)}}> <Plus/></div> :  <div onClick={()=>{!isBookmark ? setIsBookmark(false) : setIsBookmark(true)}}> <TickIcon/></div>}
                    </div>
