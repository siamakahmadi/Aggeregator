            ...
            <div key={props.key} className={Styles.cardImage}>
                ...
                <div className={theme === 'dark' ? Styles.imageToolbarDark : Styles.imageToolbarLight}>
                    <div className={Styles.add}>
                        {!isBookmark ? <div onClick={() => { !isBookmark ? setIsBookmark(true) : setIsBookmark(false) }}> <Plus /></div> : <div className={Styles.} onClick={() => { !isBookmark ? setIsBookmark(true) : setIsBookmark(false) }}> <TickIcon /></div>}
                    </div>
