...
export default function Index(props) {
    ...
    function bookmarkAction() {
        https.post(`user/bookmark/action/${id}`).then(Response => {
            ...
            <div key={props.key} className={Styles.cardImage}>
                ...
                <div className={theme === 'dark' ? Styles.imageToolbarDark : Styles.imageToolbarLight}>
                    <div className={Styles.add}>
                        {!isBookmark ? <div onClick={() => bookmarkAction}> <Plus /></div> : <div className={Styles.isBookmark} onClick={() => bookmarkAction}> <TickIcon /></div>}
                    </div>
