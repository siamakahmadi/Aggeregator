            ...
            <div className={Styles.cardImage}>
                ...
                <div className={theme === 'dark' ? Styles.imageToolbarDark : Styles.imageToolbarLight}>
                    <div className={Styles.add}>
                        {!isBookmark ? <span onClick={!isBookmark ? setIsBookmark(true)  : setIsBookmark(false) }> <Plus/></span> :  <span onClick={!isBookmark ? setIsBookmark(true)  : setIsBookmark(false) }> <TickIcon/></span>}
                    </div>
