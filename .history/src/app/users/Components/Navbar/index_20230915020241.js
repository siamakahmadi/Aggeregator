...
import Btn from '../../../dashboard/components/Btn/index'
            ...
            <div className={Styles.registerContainer}>
              <form onSubmit={props.handleSubmit}>
                ...
                <div className={Styles.inputs}>
                  <Input title="Name" placeholder="type your name" name='name' value={formData.name} onChange={props.handleChange} />
                  <Input title="Email Address" placeholder="Valid Email Address" name='email' value={formData.email} onChange={props.handleChange} />
                  <Input title=" Address" placeholder="Valid Email Address" name='email' value={formData.email} onChange={props.handleChange} />
                </div>
                ...
                <Btn submitType="submit" type="primary" title="login"  />
...
export const getServerSideProps = async (setFormData) => {
  ...
  function handleSubmit(event) {
    ...
    https.post(`user/register?name=${formData.name}&email=${formData.email}&password=${formData.pass}`)
      .then(
        Response => {
          console.log(Response)
        }
  ...
  return { props: { handleSubmit, handleChange } }
}
