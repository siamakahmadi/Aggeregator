...
export default function Index(props) {
  ...
  function handleSubmit(event) {
    ...
    https.post(`user/login?email=${formData.email}&password=${formData.pasword}`)
      .then(
        Response => {
          console.log(Response)
        }
            ...
            <div className={Styles.registerContainer}>
              <form onSubmit={handleSubmit}>
                ...
                <div className={Styles.inputs}>
                  <Input title="Email" placeholder="type your Email" name='email' value={formData.name} onChange={handleChange} />
