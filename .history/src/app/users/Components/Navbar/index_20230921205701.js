...
export default function Index(props) {
  ...
  const [ç, setRegisterData] = useState({});
  ...
  function handleRegisterSubmit(event) {
    ...
    https.post(`user/register?name=${registerData.name}&email=${registerData.email}&password=${registerData.password}&password_confirmation=${registerData.confirmPassword}`)
      .then(
        Response => {
              ...
              <div className={Styles.registerContainer}>
                <form onSubmit={handleRegisterSubmit}>
                  <div className={Styles.inputs}>
                    ...
                    <Input title="Confirm Password" placeholder="Password" name='password' value={registerData.confirmPassword} onChange={handleRegister} />
                  </div>
                  <div className={Styles.hasAccount}>
                    <div className={theme === 'light' ? Styles.text : Styles.textDark}>Already have account ?</div><Link href='#' className={Styles.link}>Sign in</Link>
                  </div>
