          ...
          <div className={Styles.container}>
            ...
            <div className={Styles.rightSide}>
              <div className={Styles.switcher}>
                <div className={props.isLight === 'dark' ? Styles.itemSelect : Styles.item} onClick={() => props.isLight === 'light' ? ()=>{cookies.set('theme', 'light', {path: '/',expires: new Date(Date.now() + 3600000)})} : ()=>{cookies.set('theme', 'dark', {path: '/',expires: new Date(Date.now() + 3600000)})}}>
                  <DarkIcon />
                </div>
