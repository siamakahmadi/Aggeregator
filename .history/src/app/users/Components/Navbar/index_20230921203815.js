...
export default function Index(props) {
  ...
  function handleRegisterSubmit(event) {
    ...
    https.post(`user/login?email=${registerData.email}&password=${registerData.password}`,
    `user/register?name=${registerData.name}&email=${registerData.email}&password=${registerData.password}&password_confirmation=${registerData.confirm}`)
      .then(
        Response => {
