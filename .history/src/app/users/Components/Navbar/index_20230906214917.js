          ...
          <div className={Styles.container}>
            ...
            <div className={Styles.rightSide}>
              <div className={Styles.switcher}>
                ...
                <div className={props.isLight === 'light' ? Styles.itemSelect : Styles.item} onClick={() => props.isLight === 'dark' ? ()=>{cookies.set('theme', 'light', {path: '/',expires: new Date(Date.now() + 3600000)})} : ()=>{cookies.set('theme', 'light', {path: '/',expires: new Date(Date.now() + 3600000)})}}>
                  <LightIcon />
                </div>
              </div>
