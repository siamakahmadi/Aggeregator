          ...
          <div className={Styles.container}>
            ...
            <div className={Styles.rightSide}>
              <div className={Styles.switcher}>
                <div className={props.isLight === 'dark' ? Styles.itemSelect : Styles.item} onClick={() => { 
                  cookies.set('theme', 'dark', { path: '/user', expires: new Date(Date.now() + 3600000) }) 
                  }}>
                  <DarkIcon />
                </div>

                <div className={props.isLight === 'light' ? Styles.itemSelect : Styles.item} onClick={() => { cookies.set('theme', 'light', { path: '/users', expires: new Date(Date.now() + 3600000) }) }}>
                  <LightIcon />
