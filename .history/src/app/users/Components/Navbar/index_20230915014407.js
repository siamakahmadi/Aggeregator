...
export const getServerSideProps = async ({ handleChange, handleSubmit }) => {
...
export default function Index(props,handleSubmit,handleChange) {
          ...
          <Modal title="Sign in" hasIcon={true} setIsEvent={setIsRegister} isEvent={isRegister}>
            <div className={Styles.registerContainer}>
              ...
              <div className={Styles.inputs}>
                ...
                <Input title="Email Address" placeholder="Valid Email Address" name='email' value={formData.email} onChange={handleChange} />
              </div>
