        ...
        <div className={Styles.body}>
          <div className={Styles.container}>
            <motion.div className={Styles.leftSide}>
              <motion.div transition={{ duration: 0.1 }} initial={{ marginTop: -60 }} animate={{ marginTop: 0 }} className={Styles.Logo}>
                <Logo />
              </motion.div>
              <div className={Styles.menuBtns}>
                <motion.div transition={{ duration: 0.3 }} initial={{ marginTop: -60 }} animate={{ marginTop: 0 }} className={Styles.categoryBtn}>
                  <CategoryBtn
                    title="All"
                    event={() =>
                      activeFilter
                ...
                <motion.div transition={{ duration: 0.4 }} initial={{ marginTop: -60}} animate={{ marginTop: 0 }} className={Styles.categoryBtn}>
                  <CategoryBtn
                    title="Display"
                    event={() =>
                      activeDisplayFilter
            ...
            <div className={Styles.rightSide}>
              <motion.div  transition={{ duration: 0.4 }} initial={{ marginTop: -60}} animate={{ marginTop: 0 }} className={Styles.categoryBtn} className={Styles.switcher}>
                <div
                  className={
