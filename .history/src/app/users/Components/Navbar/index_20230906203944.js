          ...
          <div className={Styles.container}>
            ...
            <div className={Styles.rightSide}>
              <div className={Styles.switcher}>
                <div className={props.isLight === 'dark' ? Styles.itemSelect : Styles.item} onClick={() => props.isLight === 'light' ? setDarkCookie() : setLightCookie()}>
                  {console.log(props.isLight)}
                  <DarkIcon />
                </div>

                <div className={props.isLight === 'light' ? Styles.itemSelect : Styles.item} onClick={() => props.isLight === 'dark' ? setLightCookie() : setDarkCookie()}>
                  <LightIcon />
                </div>
              </div>
