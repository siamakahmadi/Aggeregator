        ...
        <div className={Styles.body}>
          <div className={Styles.container}>
            <motion.div className={Styles.leftSide}>
              <motion.div transition={{ duration: 0.1 }} initial={{ scale: 0 }} animate={{ scale: 1 }} className={Styles.Logo}>
                <Logo />
              </motion.div>
              <div className={Styles.menuBtns}>
                <motion.div transition={{ duration: 0.3 }} initial={{ marginTop: -10 }} animate={{ marginTop: 0 }} className={Styles.categoryBtn}>
                  <CategoryBtn
                    title="All"
                    event={() =>
                      activeFilter
