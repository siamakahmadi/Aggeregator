          ...
          userValue.isLoggin === true ?
            ...
            <Modal title="Register" hasIcon={true}>
              <div className={Styles.registerContainer}>
                <form onSubmit={handleSubmit}>
                  <div className={Styles.inputs}>
                    <Input title="Name" placeholder="Type Your Name" name='name' value={handleRegister.name} onChange={handleChange} />
                    <Input title="Email Address" placeholder="Type Your Email Address" name='Email' value={formData.email} onChange={handleChange} />
                    <Input title="Password" placeholder="Password" name='password' value={formData.password} onChange={handleChange} />
                  </div>
                  <div className={Styles.hasAccount}>
                    <div className={theme === 'light' ? Styles.text : Styles.textDark}>Already have account ?</div><Link href='#' className={Styles.link}>Sign in</Link>
                  </div>
