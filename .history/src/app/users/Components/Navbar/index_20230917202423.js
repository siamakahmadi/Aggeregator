      ...
      <>
        {
          userValue.isLoggin === true ?
            ...
            <Modal title="Profile" hasIcon={true}>
              <Input title="Name" placeholder="Your Name" name='password' value={formData.password} onChange={handleChange} />
              <Input title="Email Address" placeholder="Your Email Address" name='password' value={formData.password} onChange={handleChange} />
            </Modal>
