              ...
              <Modal title="Sumbit Website" hasIcon={true}>
                <div className={Styles.registerContainer}>
                  <div className={Styles.submition}>
                    <div className={theme === "light" ? Styles.light:Styles.light}>
                        <div className={Styles.image}>
                          {theme === "light" ? <SubmitionLight/>: <SubmitionDark/>}
                        </div>
                        <div className={Styles.textbody}>
                          <span>We optimize Html.to.design power to convert live website to figma files. hence there might be some error in files. </span>
                        </div>
                    </div>
                  </div>
