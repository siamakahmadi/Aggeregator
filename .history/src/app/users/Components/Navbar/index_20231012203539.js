          ...
          <>
            {item.type === "Tags" ? (
              <Link key={item.id} href={item.name}>
                ...
                <img src={`https://radintechco.ir/echolab/public/storage/${item.icon.address}`}/>
                </SadebarItem>
              </Link>
            ) : (
              <></>
    ...
    categoryItems.message === "Category deleted" ? (
      <>
        {categoryItems.data.map((item) => (
          <>
            {item.type === "Type Face" ? (
              <SadebarItem title={item.name}><img src={item.icon.address}/></SadebarItem>
            ) : (
              <></>
            )}
          </>
  ...
  useEffect(() => {
    https
      ...
      .then((Response) => {
        ...
        console.log(Response.data.icon.address)
      })
      .catch((error) => {
        console.log(error);
      });
