...
export default function Index(props) {
  ...
  const [isCookie,setCookie] =useState()

  function setLightCookie() {
    cookies.set('theme', `${isCookie}`, {
      path: '/',
  ...
  function setDarkCookie() {
    cookies.set('theme', `${isCookie === 'light' ? setCookie('dark') : setCookie('light')}`, {
      path: '/',
      expires: new Date(Date.now() + 3600000)
    })
  }
          ...
          <div className={Styles.container}>
            ...
            <div className={Styles.rightSide}>
              <div className={Styles.switcher}>
                <div className={props.isLight === 'dark' ? Styles.itemSelect : Styles.item} onClick={() => props.isLight === 'light' ? setDarkCookie() : setDarkCookie()}>
                  <DarkIcon />
                </div>

                <div className={props.isLight === 'light' ? Styles.itemSelect : Styles.item} onClick={() => props.isLight === 'dark' ? setLightCookie() : setLightCookie()}>
                  <LightIcon />
                </div>
              </div>
