    ...
    categoryItems.message === "Category fetched" ? (
      <>
        {categoryItems.data.map((item) => (
          <>
            {item.type === "Type Face" ? (
              <Link key={item.id} href={item.name} onClick={()=>setCurrentDisplayBtn(item.name)}>
                <SadebarItem key={item.id} title={item.name}>
                  {item.name.charAt()}
                </SadebarItem>
              </Link>
              ...
              <div className={Styles.menuBtns}>
                ...
                >
                  ...
                  currentDropdownItem={currentDropdownItem}
                    title={pathname === '/users/all' ? 'All' : pathname === '/users/bookmark' ? 'Bookmark' : currentDropdownItem }
                    event={() =>
                      activeFilter
                ...
                >
                  <CategoryBtn
                    title={currentDisplayBtn> 0 ? 'display' :currentDisplayBtn}
                    event={() =>
                      activeDisplayFilter
