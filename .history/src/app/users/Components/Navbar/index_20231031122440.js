...
export default function Index(props) {
  ...
  const https = new Https('204|Ozwl7gMSErf5CZMu9zt8q4kue4AjRmxvFwIcct7n33d7ce33');
        ...
        {userValue.isLoggin === true
          ? pathname === "/users/profile" && (
              <Modal title="Profile" hasIcon={true}>
                <form onSubmit={handleUserUpdate} className={Styles.profileForm}>
                  <Input
                    title="Name"
