...
export const getServerSideProps = async ({ handleChange, handleSubmit,setIsRegister }) => {
...
export default function Index(props,handleSubmit,handleChange,setIsRegister) {
