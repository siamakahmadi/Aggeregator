...
export default function Index(props) {
  ...
  function handleRegisterSubmit(event) {
    ...
    https.post(`user/register?name=${registerData.name}&email=${registerData.email}&password=${registerData.password}`)
      .then(
        Response => {
          ...
          userValue.isLoggin === true ?
              ...
              <div className={Styles.registerContainer}>
                <form onSubmit={handleSubmit}>
                  ...
                  <div className={Styles.hasAccount}>
                    <div className={theme === 'light' ? Styles.text : Styles.textDark}>Are you want to create account?</div><Link href='/users/register' className={Styles.link}>Register</Link>
                  </div>
            ...
            <Modal title="Register" hasIcon={true}>
              <div className={Styles.registerContainer}>
                <form onSubmit={handleRegisterSubmit}>
                  <div className={Styles.inputs}>
                    <Input title="Name" placeholder="Type Your Name" name='name' value={registerData.name} onChange={handleRegister} />
                    <Input title="Email Address" placeholder="Type Your Email Address" name='email' value={registerData.email} onChange={handleRegister} />
                    <Input title="Password" placeholder="Password" name='password' value={registerData.password} onChange={handleRegister} />
                    <Input title="Confirm Password" placeholder="Confirm Password" name='confirmPassword' value={registerData.confirmPassword} onChange={handleRegister} />
                  </div>
                  <div className={Styles.hasAccount}>
                    <div className={theme === 'light' ? Styles.text : Styles.textDark}>Already have account ?</div><Link href='/users/login' className={Styles.link}>Sign in</Link>
                  </div>
                  <div className={Styles.resetPass}>
                    <Link href='#' className={Styles.link}>Forgot password ? </Link>
                  </div>
            ...
            <Modal title="Sumbit Website" hasIcon={true}>
              <div className={Styles.registerContainer}>
                <form>
                  <div className={Styles.inputs}>
                    <Input title="Web address" placeholder="Type Web address" name='name' value={registerData.name} onChange={handleRegister} />
                    <Input title="Your Name" placeholder="Type your name" name='email' value={registerData.email} onChange={handleRegister} />
                    <Input title="Description" placeholder="Type your Description" name='password' value={registerData.password} onChange={handleRegister} />
                  </div>
                  <div className={Styles.hasAccount}>
                    <div className={theme === 'light' ? Styles.text : Styles.textDark}>Already have account ?</div><Link href='/users/login' className={Styles.link}>Sign in</Link>
                  </div>
