...
export default function Page({ params }) {
  ...
  const resultFilter = filterCategory.map(item=>item.name)
  
  console.log(resultFilter === params.slug)
  ...
  return (
    <main>
      <div>
        ...
        {pathname === "/users/bookmark" ? <></> : <PageHeader title={headerContext} description={} />}
        <CardsLayout>
