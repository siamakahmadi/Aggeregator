...
export default function Home() {
  ...
  console.log(loginDone[0].token)

  // if(loginDone.status === 200){
  //   const token = generateToken({ userToken: `${loginDone.token}` }); 
  ...
  // token
  // : 
  // "27|MNixqpfLqZuo3J8XbuVV74tlPRRZC57HGtvnXaOz"
  // user_info
  // : 
  // created_at
  // : 
