...
export default function Page() {
  ...
  function senRequest() {
    https.post(`admin/category`,addCategory).then(
      Response => {
        console.log(Response)
      }
    ).catch(error => {
            ...
            <div className={styles.container}>
              ...
              <div className={styles.body}>
                <form onSubmit={handleSubmit}>
                  ...
                  <input placeholder='hithis is title' name="title" value={addCategory.title} onChange={(e) => setAddCategory(prev => ({ ...prev, title: e.target.value }))} />
                  ...
                  <div className={styles.buttons}>
                    ...
                    <button onClick={senRequest} type="submit" className={styles.saveBtn}>
                      Save
                    </button>
                  </div>
                </form>
