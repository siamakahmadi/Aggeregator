              ...
              <div className={styles.body}>
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className={styles.mt15}>
                    <Input name='page_title' value={formData.page_title} onChange={handleChange} placeholder="Add page title " title="Page title" />
                  </div>
                  <div className={styles.mt15}>
                  ...
                  <div className={styles.mt15}>
                    <Input name='title' value={formData.title} onChange={handleChange} title="Meta Title" placeholder="Meta Title" />
                  </div>
                  <div className={styles.mt15}>
        ...
        addStack ? <>
          <div className={styles.modal}>
            <div className={styles.container}>
              ...
              <div className={styles.body}>
                <Input name='name' value={formData.name} onChange={handleChange} title="Menu Title" placeholder="Add a title for category" />
