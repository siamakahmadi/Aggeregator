            ...
            <div className={styles.container}>
              ...
              <div className={styles.body}>
                ...
                <form onSubmit={handleSubmit}>
                  <Input name='name' value={formData.name} onChange={handleChange} placeholder="Add subject categories" title="Menu Title" />
                  <div className={styles.mt15}>
                    <Input name='page_title' value={formData.title} onChange={handleChange} placeholder="Add page title " title="Page title" />
                  </div>
                  <div className={styles.mt15}>
                    <Input name='type' value={formData.type} onChange={handleChange} placeholder="type" />
                  </div>
                  <div className={styles.mt15}>
                    <DescriptionInput  title="Page Description" name='page_description' value={formData.page_description} onChange={handleChange} placeholder="pageTitle" />
                  </div>
                  <div className={styles.mt15}>
                    <Input name='title' value={formData.page_title} onChange={handleChange} title="Meta Title" placeholder="Meta Title" />
                  </div>
                  <div className={styles.mt15}>
                    <Input name='meta_description' value={formData.meta_description} onChange={handleChange} placeholder="pageTitle" />
                  </div>
                  <div className={styles.mt15}>
                    <DescriptionInput  title="Page Description" name='meta_description' value={formData.meta_description} onChange={handleChange} placeholder="pageTitle" />
                  </div>
