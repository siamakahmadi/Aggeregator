            ...
            <div className={styles.container}>
              ...
              <div className={styles.body}>
                ...
                <form onSubmit={handleSubmit}>
                  <Input name='name' value={formData.name} onChange={handleChange} placeholder="Add subject categories" title="Title" />
                  <Input name='title' value={formData.title} onChange={handleChange} placeholder="Add subject categories " title="Page title" />
                  <Input name='type' value={formData.type} onChange={handleChange} placeholder="Add subject categories " />
