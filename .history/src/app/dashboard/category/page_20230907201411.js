...
export default function Page() {
  ...
  const addCategory = async (e) => {
    ...
    const pageTitle = e.get("pageTitle").toString();
    const pageDes = e.get("pageDes").toString();
    const metaDes = e.get("metaDes").toString();
  }
            ...
            <div className={styles.container}>
              ...
              <div className={styles.body}>
                ...
                <form action={addCategory}>
                  <Input name='name' title="Menu Title" placeholder="Add a title for category" />
                  <Input name='type' title="Page Title" placeholder="This title will show on page header" />
                  <Input name='title' title="Page Description" placeholder="This description will show on page header" />
                  <Input name='pageTitle' title="Page tag" placeholder="This is the title " />
                  <Input name='pageDes' title="Meta Description" placeholder="This is the Meta description" />
                  <Input name='metaDes' title="Meta Description" placeholder="This is the Meta description" />
