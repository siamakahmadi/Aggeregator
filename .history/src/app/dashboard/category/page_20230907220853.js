...
export default function Page() {
  ...
  const [postCategro, setPostCategory] = useState({
    name: '',
    type: 'Tags',
    title: 'sdsd',
    page_title: 'deasasa',
    page_description: 'dffdfdf',
    meta_description: 'asasa'
  })
  ...
  //   title:'asass',
  //   page_title:'asas',
  //   page_description:'asaa',
  //   meta_description:'asasa'
  // }

  function add() {
    https.post('admin/category', postCategro, {
      headers: {
            ...
            <div className={styles.title} onClick={() => add()}>
              ...
              <div>
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <input placeholder='page_title' name="page_title" value={formData.page_title} onChange={handleChange} />
                  <input placeholder='page_description' name="page_description" value={formData.page_description} onChange={handleChange} />
                  <input placeholder='meta_description' name="meta_description" value={formData.meta_description} onChange={handleChange} />
          ...
          <div className={styles.modal}>
            <div className={styles.container}>
              ...
              <form onSubmit={handleSubmit}>
                  ...
                  <Input name='name' title="meta_description" value={formData.meta_description} onChange={handleChange} placeholder="pageTitle" />
                  <Input name='title' title="title" value={formData.title} onChange={handleChange} placeholder="Add a title for category" />
                  <Input name='type' title="title" value={formData.type} onChange={handleChange} placeholder="Type" />
                  <Input name='pageTitle' title="pageTitle" value={formData.pageTitle} onChange={handleChange} placeholder="pageTitle" />
                  <Input name='page_description' title="page_description" value={formData.page_description} onChange={handleChange} placeholder="pageTitle" />
                  <Input name='meta_description' title="meta_description" value={formData.meta_description} onChange={handleChange} placeholder="pageTitle" />
