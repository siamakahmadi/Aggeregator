            ...
            <div className={styles.container}>
              ...
              <div className={styles.body}>
                <form onSubmit={handleSubmit}>
                  <Input onChange={handleChange} title="Menu Title" placeholder="Add a title for category" />

                  <input name="title" value={addCategory.title} onChange={(e) => setAddCategory(prev => ({...prev, title: e.target.value}))}/>
                  ...
                  <div className={styles.buttons}>
                    <div type="submit" className={styles.discardBtn} onClick={() => addTag ? setAddTag(false) : setAddTag(true)} >
                      Discard
                    </div>
