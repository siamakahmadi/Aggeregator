...
export default function page() {
  ...
  useEffect(() => {
    https.get('admin/category/index').then(Response => {
      setCategory(Response.data)}).catch(error => {
      console.log(error)
    })
  }, [])
  ...
  // const categoryList = category.data.map(items => 
  //   <div>{items.title}</div>
  // )
    ...
    <div>
      ...
      <div className={styles.itemsContainer}>
        ...
        <div className={styles.container}>
          ...
          {category.message === "Category deleted" ? <div>Successfull</div> :  <div>wating...</div>  }
