            ...
            <div className={styles.container}>
              ...
              <div className={styles.body}>
                ...
                <form onSubmit={handleSubmit}>
                  <Input name='name' value={formData.name} onChange={handleChange} placeholder="Add subject categories" title="Menue Title" />
                  <div className={styles.mt15}>
                    <Input name='title' value={formData.title} onChange={handleChange} placeholder="Add page title " title="Page title" />
                  </div>
                  <div className={styles.mt15}>
