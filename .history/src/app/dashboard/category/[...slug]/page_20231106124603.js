...
export default function Page() {
  ...
  useEffect(() => {
    https
      ...
      .then((Response) => {
        setCategory(Response.data), toast("categories successfully featched");
      })
      .catch((error) => {
  ...
  function deleteItem(id) {
    https
      ...
      .then((Response) => {
        toast.success("Category Sucessfully fetched");
      })
      .catch((error) => {
            ...
            <div className={styles.container}>
              ...
              <div className={styles.body}>
                <form onSubmit={handleSubmit}>
                  ...
                  <div className={styles.mt15}                       name="title">
                    <select value={formData.page_description}>
                      <option>Tags</option>
