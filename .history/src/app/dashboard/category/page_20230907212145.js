            ...
            <div className={styles.title} onClick={()=>add()}>
              ...
              <div> test input
                <form action={form}>
                  ...
                  <input name={form.type} placeholder='title'/>
                  <input name='page_title' placeholder='page_title'/>
                  <input name='page_description' placeholder='page_description'/>
                  <input name='meta_description' placeholder='meta_description'/>
                </form>
              </div>
            </div>
