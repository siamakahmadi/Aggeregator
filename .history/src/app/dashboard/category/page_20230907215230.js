            ...
            <div className={styles.title} onClick={() => add()}>
              ...
              <div>
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <input placeholder='name' name="type" value={formData.type} onChange={handleChange} />

                  <input placeholder='name' name="title" value={formData.title} onChange={handleChange} />
                  <input placeholder='name' name="page_title" value={formData.page_title} onChange={handleChange} />
                  <input placeholder='name' name="page_description" value={formData.page_description} onChange={handleChange} />
                  <input placeholder='name' name="meta_description" value={formData.meta_description} onChange={handleChange} />
