            ...
            <div className={styles.container}>
              ...
              <div className={styles.body}>
                ...
                <div className={styles.buttons}>
                  <div className={styles.discardBtn} onClick={()=> addItemModal ? setAddItemModal(false) : setAddItemModal(true)} >
                    Discard
                    // onClick={()=> addItemModal ? setAddItemModal(false) :addItemModal, setAddItemModal(true)}
                  </div>
