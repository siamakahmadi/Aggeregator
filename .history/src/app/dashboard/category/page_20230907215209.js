            ...
            <div className={styles.title} onClick={() => add()}>
              ...
              <div>
                ...
                <form onSubmit={handleSubmit}>
                  <input placeholder='' name="name" value={formData.name} onChange={handleChange} />

                  <input name="type" value={formData.type} onChange={handleChange} />

                  <input name="title" value={formData.title} onChange={handleChange} />
                  <input name="page_title" value={formData.page_title} onChange={handleChange} />
                  <input name="page_description" value={formData.page_description} onChange={handleChange} />
                  <input name="meta_description" value={formData.meta_description} onChange={handleChange} />
