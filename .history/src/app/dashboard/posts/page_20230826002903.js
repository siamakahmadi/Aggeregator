...
export default function page() {
  ...
  useEffect(() => {
    https.get('admin/browse/post?search=t&sort=created_at&category=test&paginate=10&sort_type=ASC&status=Published',au'2|PCN9OTbqddSOktwjF8UgWUvvmUSPP1a5Akfx9gSF').then(Response => {
