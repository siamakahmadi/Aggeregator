...
export default function NewPost({ params }) {
  ...
  function handleSubmit(event) {
    ...
    https
      .post(`admin/post/${params.id}?_method=PUT`, formData, {
        headers: {
  ...
  function deletePost() {
    https
      .post(`admin/post/action/${params.id}?action=delete`)
      .then((Response) => {
        console.log(Response);
      })
      .catch((error) => {
      ...
      <form onSubmit={handleSubmit}>
        ...
        >
          <div className={styles.btns}>
            <div className={styles.btn} hasIcon={true} onClick={() => deletePost}>
              <svg
                width="20"
                height="20"
                viewBox="0 0 20 20"
            ...
            <div title="Draft"className={styles.btn}>
          ...
          >
            ...
            <div className={styles.mt24}>
              <DescriptionInput
                ...
                Description="275 characters left"
              />
            </div>
          </InputContainer>
