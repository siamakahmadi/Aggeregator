          ...
          <div key={item.id} className={styles.row}>
            ...
            <div className={styles.rightSide}>
              ...
              <a className={styles.Functional} >
                {item.status === 'Published' ? <p className={styles.draft} onClick={() => switchDraft(item.id, 'draft')}>Draft</p> : <p<p className={styles.draft}onClick={() => switchDraft(item.id, 'publish')}>Publish</p>}
              </a>
