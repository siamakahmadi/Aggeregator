...
export default function NewPost() {
  ...
  function handleSubmit(event) {
    ...
    if (Array.isArray(formData.version_picture) && formData.version_picture.length > 0) {
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className={styles.Inputs}>
          ...
          <InputContainer title="Alboum" description="Pic Gallery">
            <ImageUploader name='version_picture' value={formData.version_picture} onChange={handleFileChange} />
          </InputContainer>
        </div>
      </form>
