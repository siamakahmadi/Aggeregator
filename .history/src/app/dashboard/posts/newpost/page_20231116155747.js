...
export default function NewPost() {
  ...
  function handleSubmit(event) {
    ...
    formData.append("type_face", formData.type_face);
    formData.append("website", formData.website);
    formData.append("version_number", formData.version_number);
    formData.append("version_title", formData.version_title);
    formData.append("version_date_added", formData.version_date_added);
  
    // Append the file
    formData.append("version_picture", selectedFile);
  
    // You may need to adjust the endpoint and headers based on your API
    https
