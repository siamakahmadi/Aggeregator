    ...
    <main>
      <PageHeader title="New Post" description="View your team’s trades and transactions.">
        <div className={styles.btns}>
          ...
          <Btn title="Draft" />
          <Btn title="Publish" hasIcon={true} type="primary">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <form onSubmit={handleSubmit}>
        <div className={styles.Inputs}>
          <InputContainer title="Featured">
            ...
            <Input name='name' value={formData.name} onChange={handleChange} placeholder="Enter a number" title="Priority" />
          </InputContainer>

          <InputContainer title="Main info" description="Update your photo and personal details here.">
            <Input name='name' value={formData.name} onChange={handleChange} placeholder="Enter a title" title="Title" />
          ...
          <InputContainer title="Category info" description="Select your category">
            <Input name='name' value={formData.name} onChange={handleChange} placeholder="Enter full website link" title="Website" />
            <div className={styles.mt24}>
              <Input name='name' value={formData.name} onChange={handleChange} placeholder="Enter full permlink link" title="Enter full permlink website" />
            </div>
          </InputContainer>

          <InputContainer title="Version Info" description="type version detail complete">
            <Input name='name' value={formData.name} onChange={handleChange} placeholder="Enter Version" title="Version" />
          </InputContainer>
        </div>
      </form>
