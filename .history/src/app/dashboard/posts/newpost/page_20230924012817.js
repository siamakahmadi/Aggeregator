        ...
        <div className={styles.Inputs}>
          ...
          <InputContainer title="Category info" description="Select your category">
            <div className={styles.mb24}>
              <Category name='category' value={formData.category} onChange={handleChange} placeholder="Select a category" title="Category" />
            </div>
            <div className={styles.mb24}>
              <Input name='category' value={formData.category} onChange={handleChange} placeholder="Select a category" title="Category" />
            </div>
            <div className={styles.mb24}>
