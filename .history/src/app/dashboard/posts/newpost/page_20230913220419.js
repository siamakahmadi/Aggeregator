      ...
      <form>
        <div className={styles.Inputs}>
          ...
          <InputContainer title="Category info" description="Select your category">
            ...
            <Input placeholder="Enter full permlink link" title="Enter full permlink website" />            <Input placeholder="Enter full permlink link" title="Enter full permlink website" />
