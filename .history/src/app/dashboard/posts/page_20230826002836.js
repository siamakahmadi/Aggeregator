...
export default function page() {
  ...
  useEffect(() => {
    https.get('admin/browse/post?search=t&sort=created_at&category=test&paginate=10&sort_type=ASC&status=Published',config.headers.Authorization = `Bearer ${token}`;).then(Response => {
