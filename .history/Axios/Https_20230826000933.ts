import axios, { Axios, AxiosHeaderValue,Authorization, AxiosInstance, AxiosResponse } from "axios";
...
export default class Http {
    ...
    constructor() {
        ...
        axios.defaults.headers.common['Authorization'] = '2|PCN9OTbqddSOktwjF8UgWUvvmUSPP1a5Akfx9gSF';
    }
