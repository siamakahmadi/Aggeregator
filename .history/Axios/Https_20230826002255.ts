...
export default class Http {
    ...
    constructor() {
        ...
        this.token = axios.defaults.headers.common['Authorization'] = '2|PCN9OTbqddSOktwjF8UgWUvvmUSPP1a5Akfx9gSF';
        config.headers.Authorization = `Bearer ${token}`;
    }

    public post(endPoint: string, params: object): Promise<AxiosResponse> {
        return this.instance.post(`${this.baseUrl}${endPoint} , this.token`, params   )
    }
